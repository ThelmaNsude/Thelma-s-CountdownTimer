...
const countdowndate = new Date(2024, 2, 8, 11, 30, 0 ).getTime();//june, 3 2024. 11:30am
...
const timer = setInterval(() => {
    ...
    //to calculate minutes(we get the remainder from hours and divide by one minute)
    ...
    document.getElementById("countdown-hours").innerHTML = hour;
    document.getElementById("countdown-minutes").innerHTML = min;
    document.getElementById("countdown-seconds").innerHTML = sec;

    if(difference < 0/*meaning that countdown is over*/){
    clearInterval(timer);//stop timer
    document.getElementById("countdown_over").innerHTML = "The Countdown is over, tHE WINNER is Chukwu Munachimso Claire"
}
